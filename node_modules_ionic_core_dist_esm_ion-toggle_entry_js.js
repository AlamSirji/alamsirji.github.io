...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.didLoad = false;
    this.setupGesture = /*#__PURE__*/(0,C_Users_AlamSirji_Documents_Projects_Ionic_portfolio_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
